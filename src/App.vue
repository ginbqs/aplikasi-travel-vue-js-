<template>
  <div id="app">
    <nav class="relative bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600 ">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 ">
        <router-link :to="{ name: 'Home'}" href="https://flowbite.com/" class="flex items-center">
          <img src="img/tj0.jpg" class="h-8 mr-3" alt="Flowbite Logo">
          <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">BusKoe</span>
        </router-link>
